...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DishBasket>(entity =>
        {
            ...
            entity.HasOne(d => d.Dish).WithMany(p => p.DishBaskets).HasForeignKey(d => d.DishId);

            entity.HasOne(d => d.Order).WithMany(p => p.DishBaskets).HasForeignKey(d => d.OrderId);

            entity.HasOne(d => d.User).WithMany(p => p.DishBaskets).HasForeignKey(d => d.UserId);
        });
        ...
        modelBuilder.Entity<Rating>(entity =>
        {
            ...
            entity.HasOne(d => d.Dish).WithMany(p => p.Ratings).HasForeignKey(d => d.DishId);
